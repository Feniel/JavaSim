...
public class MachineShop extends SimulationProcess
{
    ...
    public void run ()
    {
        try
        {
            ...
            MachineShop.Machine1 = new Machine(8);
            MachineShop.DataMonitor = new Monitor(JobQ);
            Job J = new Job();
            ...
            MachineShop.DataMonitor.terminate();
            MachineShop.Machine1.terminate();
    ...
    public static Machine Machine1 = null;

    public static Monitor DataMonitor = null;
